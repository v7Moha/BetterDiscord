...
.theme-dark .layer-3QrUeG, .theme-dark .layers-3iHuyZ, .appMount-3VJmYg {
    background:url('https://i.imgur.com/hwseeIN.jpg');
}
...
/* Emoji Area */
.emojiPicker-3m1S-j, .category-2U57w6, .emojiPicker-3m1S-j .stickyHeader-1SS0JU {
    background: rgba(0,0,0,0.0);
    color: #ffffff;
}
.emojiPicker-3m1S-j {
...
.popoutTop-3uu9vG.noArrow-3BYQ0Z, .popoutTopRight-3BzFIE.noArrow-3BYQ0Z {
...
.theme-dark .isMentionedCozy-3isp7y:after {
    background: transparent;
    border-left: 4px solid rgb(26, 250, 226);
}
...
.inner-1JeGVc {
    border: 3px solid hsla(0, 3%, 27%, 0.3);
}
